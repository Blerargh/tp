...
| **Delete**                | `delete ct/CONTACT_INDICES...` e.g., `delete ct/3`<br>`delete ass/ASSIGNMENT_NAME` e.g., `delete ass/Assignment 11`<br>`delete c/CLASS_NAME` e.g., `delete c/CS2103T T10 1 T14`                                                                                   | None            |
| **Clear**                 | `clear`                                                                                                                                                                                                                                                           | None            |
| **Exit**                  | `exit`                                                                                                                                                                                                                                                            | None            |
